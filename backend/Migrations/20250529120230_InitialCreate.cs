        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockQuantity = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    ReorderLevel = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReturnToSupplier", x => x.ReturnID);
                    table.ForeignKey(
