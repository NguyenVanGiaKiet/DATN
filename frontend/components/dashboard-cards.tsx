    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="text-xs text-muted-foreground">Tổng nhà cung cấp: {stats.activeSuppliers}</div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="text-xs text-muted-foreground">Tổng đơn hàng: {stats.totalOrders}</div>
        </CardContent>
      </Card>
